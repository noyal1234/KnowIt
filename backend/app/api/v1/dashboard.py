...
from app.models.schemas import DashboardSummary, DashboardTrends, TopConcernIngredient
...
async def dashboard_alerts(
    ...
    return {"active_alerts_count": summary.active_alerts_count, "recent_products": summary.recent_products}
